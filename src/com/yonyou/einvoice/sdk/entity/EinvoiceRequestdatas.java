...
public class EinvoiceRequestdatas extends EinvoiceObject {
	 ...
	 * 发票明细
	 */
	private List<EinvoiceRequestdatasInventory> item;
	...
	public List<EinvoiceRequestdatasInventory> getItem() {
		return item;
	}
	public void setItem(List<EinvoiceRequestdatasInventory> item) {
		this.item = item;
	}
	@Override
	public String toString() {
		return "EinvoiceRequestdatas [FPQQLSH=" + FPQQLSH + ", FPLX=" + FPLX + ", XSF_NSRSBH=" + XSF_NSRSBH
				+ ", XSF_MC=" + XSF_MC + ", XSF_DZDH=" + XSF_DZDH + ", XSF_YHZH=" + XSF_YHZH + ", GMF_NSRSBH="
				+ GMF_NSRSBH + ", GMF_MC=" + GMF_MC + ", GMF_DZDH=" + GMF_DZDH + ", GMF_YHZH=" + GMF_YHZH + ", KPR="
				+ KPR + ", SKR=" + SKR + ", FHR=" + FHR + ", BZ=" + BZ + ", LYID=" + LYID + ", BMB_BBH=" + BMB_BBH
				+ ", ORGCODE=" + ORGCODE + ", JSHJ=" + JSHJ + ", HJJE=" + HJJE + ", HJSE=" + HJSE + ", item=" + item
				+ "]";
	}
